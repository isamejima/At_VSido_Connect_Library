...
TEST(AT_VSIDO_CONNECT_LIBRARY_Test, op_o_test_target_0)
{
    ...
    unsigned char form_pc_packet[] = { 0xff, 0x6f, 0x08, 0x02,
        0x01, 0x00, 0x00, 0x9b };
    unsigned char return_packet[] = { 0xff, 0x6f, 0x08, 0x01,
        0x00, 0x00, 0x00, 0x99 };
...
TEST(AT_VSIDO_CONNECT_LIBRARY_Test, op_t_test_target_0)
{
    ...
    unsigned char form_pc_packet[] = { 0xff, 0x74, 0x08, 0x02,
        0x01, 0x00, 0x00, 0x80 };
    unsigned char return_packet[] = { 0xff, 0x74, 0x08, 0x01,
        0x00, 0x00, 0x00, 0x82 };
